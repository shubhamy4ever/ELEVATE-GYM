  ...
  return (
    <motion.div 
      className={`bg-white rounded-xl overflow-hidden shadow-lg relative ${
        isPopular ? 'transform scale-105 md:translate-y-0 border-2 border-[#FF3366] mt-5' : ''
      }`}
      variants={fadeIn}
      whileHover="hover"
      initial="rest"
    ...
    >
      {isPopular && (
        <div className="bg-[#FF3366] absolute -top-3 left-1/2 transform -translate-x-1/2 py-1 px-4 rounded-full shadow-lg z-10 whitespace-nowrap">
